# Example EDM (Service notice planned maintenance)
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="width:100%;max-width:600px;background:#FFFFFF;">
        ...
        <tr>
          <td style="padding:24px 30px;font-family:Arial,Helvetica,sans-serif;color:#353947;font-size:16px;line-height:24px;">
            <h1 style="margin:0 0 16px 0;font-family:Arial,Helvetica,sans-serif;font-size:26px;line-height:32px;color:#470A68;">Planned maintenance in your area</h1>
            <p style="margin:0 0 16px 0;">Hey &lt;FIRSTNAME&gt;</p>
            <p style="margin:0 0 16px 0;">We’re completing planned maintenance to improve your Dodo Internet service.</p>
            <p style="margin:0 0 16px 0;">You may experience a short interruption on &lt;DATE&gt; between &lt;START_TIME&gt;–&lt;END_TIME&gt; AEST.</p>
            <p style="margin:0 0 24px 0;">If you’re offline after this window, restart your modem. If the issue continues, contact us below.</p>
            ...
            <p style="margin:0 0 16px 0;">We’re here to help. If you need more info or have any questions, <a href="https://www.dodo.com/account" style="color:#470A68;text-decoration:none;font-weight:bold;">log in to My Dodo</a> and let us know.</p>
            <p style="margin:0;">Thanks for your patience while we make improvements</p>
          </td>
        </tr>
        <tr>
