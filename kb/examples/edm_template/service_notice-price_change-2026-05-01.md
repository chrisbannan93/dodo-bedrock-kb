# Example EDM (Service notice price change)

**comm_type:** service_notice
**campaign_type:** price_change
**product:** internet
**audience_stage:** active
**date_sent:** 2026-05-01
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="width:100%;max-width:600px;background:#FFFFFF;">
        ...
        <tr>
          <td style="padding:24px 30px;font-family:Arial,Helvetica,sans-serif;color:#353947;font-size:16px;line-height:24px;">
            <h1 style="margin:0 0 16px 0;font-family:Arial,Helvetica,sans-serif;font-size:26px;line-height:32px;color:#470A68;">Price change for your Dodo plan</h1>
            <p style="margin:0 0 16px 0;">Hey &lt;FIRSTNAME&gt;</p>
            <p style="margin:0 0 16px 0;">Your monthly charge will change from &lt;OLD_AMOUNT&gt; to &lt;NEW_AMOUNT&gt; on &lt;DATE&gt;.</p>
            <p style="margin:0 0 24px 0;">If you have questions about this change, we’re here to help.</p>
            ...
            <p style="margin:0;">Thanks for being with Dodo</p>
          </td>
        </tr>
        <tr>
